...
// what is the diffrance between mext/navigation and next/router
...
const RentModal = () => {
  ...
  // these function is watching the value of a certen properrty for the given form value
  ...
  return (
    <Modal
      ...
      //i need to under stande how do we use handelSubmit as an interface and as a fuc at same time
